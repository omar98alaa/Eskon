    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RedirectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RejectionMessage = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_AssignedAdminId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Bookings",
                columns: new[] { "UserId", "PropertyId", "StartDate", "EndDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_UserId_PropertyId",
                table: "Favourites",
