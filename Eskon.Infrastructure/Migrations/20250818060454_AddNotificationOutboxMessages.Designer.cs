...
namespace Askon.Infrastructure.Migrations
{
    ...
    [Migration("20250818060454_AddNotificationOutboxMessages")]
    partial class AddNotificationOutboxMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.Identity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.Identity.UserRoles", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.NotificationOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Eskon.Domian.Models.Booking", b =>
                {
                    ...
                    b.HasIndex("CustomerId", "PropertyId", "StartDate", "EndDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.Identity.UserRoles", b =>
                {
                    b.HasOne("Eskon.Domian.Entities.Identity.Role", "Role")
                        .WithMany("UserRoles")
