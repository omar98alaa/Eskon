...
namespace Askon.Infrastructure.Migrations
{
    ...
    [Migration("20250723120511_AddEscrowAndPaymentEntities")]
    partial class AddEscrowAndPaymentEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.EscrowTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<bool>("IsReleasedToOwner")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.PaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.EscrowTransaction", b =>
                {
                    ...
                    b.HasOne("Eskon.Domian.Entities.Identity.User", "Customer")
                        .WithMany("EscrowTransactionsOut")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Eskon.Domian.Entities.Identity.User", "Owner")
                        .WithMany("EscrowTransactionsIn")
            ...
            modelBuilder.Entity("Eskon.Domian.Entities.Identity.User", b =>
                {
                    ...
                    b.Navigation("EscrowTransactionsIn");

                    b.Navigation("EscrowTransactionsOut");
